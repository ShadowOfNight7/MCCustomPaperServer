...
execute as @s[scores={playerhit=1}] at @s if data entity @s equipment.chest.components."minecraft:custom_data".experience run summon experience_orb ~ ~ ~ {Value:1,Tags:["ExperienceArmor"]}
...
execute as @s[scores={playerhit=1}] at @s if data entity @s equipment.legs.components."minecraft:custom_data".experience run summon experience_orb ~ ~ ~ {Value:1,Tags:["ExperienceArmor"]}
...
execute as @s[scores={playerhit=1}] at @s if data entity @s equipment.feet.components."minecraft:custom_data".experience run summon experience_orb ~ ~ ~ {Value:1,Tags:["ExperienceArmor"]}
