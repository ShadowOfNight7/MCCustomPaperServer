...
execute unless entity @e[type=interaction,tag=ArmorSmith] as @s at @s run summon interaction ~ ~ ~ {Tags:["TheArmorSmith","TheArmorSmithInitial","TheArmorSmithWeaker"],height:0.5f,width:0.5f}
