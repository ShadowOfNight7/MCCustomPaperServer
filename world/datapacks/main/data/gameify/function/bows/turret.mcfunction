...
execute as @s at @s positioned ~ ~ ~ run rotate @s facing entity @e[type=!item,type=!item_display,type=!item_frame,type=!glow_item_frame,type=!#minecraft:boat,type=!minecart,type=!tnt_minecart,type=!tnt,type=!furnace_minecart,type=!block_display,type=!text_display,type=!#minecraft:impact_projectiles,type=!#minecraft:deflects_projectiles,type=!armor_stand,type=!#arrows,tag=!TurretOwner,distance=..25,nbt=!{HurtTime:9s},nbt=!{HurtTime:8s},nbt=!{HurtTime:7s},nbt=!{HurtTime:6s},nbt=!{HurtTime:5s},nbt=!{HurtTime:4s},nbt=!{HurtTime:3s},limit=1,sort=nearest] feet
