...
execute as @s at @s run data modify entity @e[type=armor_stand,tag=CrossbowReloader,limit=1] equipment.mainhand set from entity @s equipment.offhand
...
execute as @s at @s if score @s crossbowCart matches 1 run data modify entity @e[type=armor_stand,tag=CrossbowReloader,limit=1] equipment.offhand.components."minecraft:charged_projectiles"[0] set value {id:"minecraft:arrow"}
...
execute as @s at @s if entity @s[nbt={equipment:{offhand:{components:{"minecraft:charged_projectiles":[{id:"minecraft:arrow"}]}}}}] run data modify entity @e[type=item,tag=TheItemCrossbow,limit=1] Item.id set value "minecraft:arrow"
