...
execute as @e[type=#gameify:mobs,scores={enchant.counter=1}] at @s run title @s actionbar [{"text":"     ","color":"red"}]
execute as @e[type=#gameify:mobs,scores={enchant.counter=1}] at @s run say a
