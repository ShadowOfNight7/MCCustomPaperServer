...
execute as @a[tag=Knight,scores={knightAbilityInitial=1..}] at @s run scoreboard players remove @s knightAbilityInitial 1
execute as @a[tag=Knight,scores={knightAbilityInitial=1}] at @s run function gameify:abilities/knight_3 with entity @s
...
execute as @a[tag=Knight,scores={knightAbilityInitial2=1..}] at @s run scoreboard players remove @s knightAbilityInitial2 1
execute as @a[tag=Knight,scores={knightAbilityInitial2=1}] at @s run function gameify:abilities/knight_4 with entity @s
...
execute as @e[type=#gameify:mobs,scores={enchant.counter=1..}] at @s run function gameify:swords/counter_indication with entity @s
...
execute as @e[type=armor_stand,tag=Dummy] at @s as @e[type=#gameify:hostile_mobs,type=!wither,type=!ender_dragon,type=!warden,type=!elder_guardian,type=!creaking,distance=..7.5] at @s facing entity @e[type=armor_stand,tag=Dummy,limit=1] feet if block ^ ^ ^0.1 #gameify:transparent_blocks run tp @s ^ ^ ^0.1 ~ ~
execute as @e[type=armor_stand,tag=Dummy] at @s as @e[type=#arrows,distance=..7.5] at @s run function gameify:bows/dummyarrow with entity @s
