...
give @s[nbt={active_effects:[{id:"minecraft:luck",amplifier:76b}]}] debug_stick[custom_name=[{"text":"Life Essence","italic":false,"color":"blue"}],lore=[[{"text":"It feels as fragile as glass yet unable to be broken.","italic":false,"color":"gray"}]],rarity=rare,enchantment_glint_override=true,item_model="minecraft:dragon_breath",tooltip_display={hidden_components:[enchantments]},custom_data={life_essence:true},max_stack_size=1]
