...
execute if score @s enchant.counter matches 4..5 as @a at @s if score @s id = @e[type=#gameify:mobs,tag=CounterMarker,limit=1] enchant.counter2 positioned as @e[type=#gameify:mobs,tag=CounterMarker,limit=1] run particle dust{color:13616435,scale:4} ~ ~1 ~ 0.7 2 0.7 0.2 120 normal @s
