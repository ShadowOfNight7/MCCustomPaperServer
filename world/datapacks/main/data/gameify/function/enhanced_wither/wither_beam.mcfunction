...
execute as @s[scores={time=41}] at @s positioned ~-1 ~-50 ~-1 as @e[type=!#wither_friends,dx=2,dz=2,dy=100] at @s run damage @s 10 magic by @e[type=wither,limit=1,sort=nearest] from @e[type=wither,limit=1,sort=nearest]
