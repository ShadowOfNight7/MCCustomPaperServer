...
execute as @s[tag=!Phase2,scores={health=..2500000}] at @s run scoreboard players set @e[type=marker,tag=!AliveEndCrystal] random 8790
execute as @s[tag=!Phase2,scores={health=..2500000}] at @s run tag @s add Phase2