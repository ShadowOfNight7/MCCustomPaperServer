...
- **Elder Sage** - If the high preist is the Emperor's right hand you are his left, you have been personally hand picked by the emperor to wield the divine swords. Having been around the best and the brightest for many years you have pioneered a new field of magic. One which disables that of others
...
- **Chaplain** - You do no believe in war or its supposed benefits, however, you still joined the war effort so that less souls may suffer. Primary ability, `<ability>` (CD: n seconds, duration: n seconds), is rooted in years you served in the moritican wing; you can, on command, create a home made brew of potions that grants regeneration, speed, and instant saturation. Your alternate ability, `<ability>` (CD: n seconds, duration: n seconds, radius: n blocks), allows you to spawn cobwebs around nearby enemies.
